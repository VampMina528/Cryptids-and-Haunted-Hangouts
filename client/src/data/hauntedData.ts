export const hauntedData = [
  ...
  },
  {
    ...
    description:
      'Once a finishing school for girls, this Victorian-era hotel is haunted by the spirit of its former headmistress. Guests report having their luggage unpacked or being tucked in at night.',
    images: ['queen-anne-hotel.jpg', 'QueenBedroom.jpg', 'queen-anne.jpg'],
    externalLink: 'https://www.hauntedrooms.com/california/san-francisco/haunted-places/haunted-hotels/queen-anne-hotel',
  },
  {
    id: 'urraca-mesa',
    name: 'Urraca Mesa / Casa del Gavilan',
