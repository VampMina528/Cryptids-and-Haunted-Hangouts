...
export const cryptids = [
  {
    ...
    description: 'In the shadows of Point Pleasant lurks a winged enigma. The Mothman — eyes glowing crimson — glides through the night air, foretelling doom. Its legend began during a flurry of sightings in 1966, culminating in the Silver Bridge collapse. Some say it still watches, waiting...',
  ...
  },
  {
    ...
    description: 'He roams the forests like a phantom — massive, matted, and menacing. Sasquatch, or Bigfoot, is said to be a wild man from ancient tales. Those who glimpse him report a stench of decay... and the feeling they’re being hunted.',
  ...
  },
  {
    ...
    description: 'At Skinwalker Ranch, the land seethes with ancient malice. Cattle are found dismembered. Lights dance in the dark. The Skinwalker — a cursed Navajo witch — can wear the shape of beast or man, and speaks in voices that don’t belong.',
  ...
  },
  {
    ...
    description: 'In the plains of Kansas, headless wanderers — the Blemmyes — haunt the edges of forgotten fields. Their hollow shoulders breathe, and their faces emerge where chests should be. They are remnants of a time when monsters walked in plain sight.',
  ...
  },
  {
    ...
    description: 'With fangs like needles and leathery wings, El Chupacabra stalks the night. Born from blood and myth, it drains livestock dry and vanishes into the dark. Some say it’s a failed experiment. Others know it’s worse.',
  ...
  },
  {
    ...
    description: 'Deep in the rainforest walks Curupira — backwards feet twisting tracks in tangled roots. He defends the forest with illusion and madness, punishing intruders with endless wandering.',
  ...
  },
  {
    ...
    description: 'Below the black waters of Loch Ness, something vast stirs. Nessie — long-necked and ancient — emerges in ripples and mist. Eyewitnesses whisper, sonar pings vanish, and the legend never sleeps.',
  ...
  },
  {
    ...
    description: 'As night falls in the Philippines, the Aswang awakens. Shape-shifting into winged beasts, it hunts expectant mothers, drinks blood, and drifts through roofs as smoke. Even the brave bolt doors tight.',
  ...
  },
  {
    ...
    description: 'In the Pine Barrens, it screams. The Jersey Devil — twisted limbs, horns, hooves, wings — is said to be cursed from birth. Hunters have seen its shadow; none have seen it twice.',
  ...
  },
  {
    ...
    description: 'Something massive lurks near Bray Road — a snarling, upright wolf with human eyes. Sightings date to 1936. Locals warn: if you see it once, don’t look back.',
  ...
  },
  {
    ...
    description: 'Silhouettes stretch along California ridges — tall, cloaked, unmoving. The Dark Watchers stand at dusk and vanish if approached. They never speak. They only observe.',
